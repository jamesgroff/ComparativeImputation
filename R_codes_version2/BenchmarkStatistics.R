...
# Print one of the lists for verification
print(full_significant_list_conditions_proteinGroups)
...
fold_changed_conditions_proteinGroups <- fold_change_filter(filtered_conditions_proteinGroups)
fold_changed_conditions_Phosphosites <- fold_change_filter(filtered_conditions_Phosphosites)
fold_changed_conditions_normedPhosphosites <- fold_change_filter(filtered_conditions_normedPhosphosites)
...
# Print one of the lists for verification
print(list_fold_significant_conditions_proteinGroups)
