...
summary_hist_intensities <- plot_histogram(df_by_intensities_list, "", "Histogram_by_intensities_MV.pdf")
summary_hist_cond_labels <- plot_histogram(df_by_conditions_labels_list, "Ratio", "Histogram_by_conditions_labels_MV.pdf")
summary_hist_cond_intensities <- plot_histogram(df_by_conditions_intensities_list, "", "Histogram_by_conditions_intensities_MV.pdf")
