...
save(average_CM_overall_proteinGroups, file="average_CM_proteinGroups_without_full_MV.RData")
save(average_CM_overall_Phophosites, file="average_CM_Phospho(STY)Sites_without_full_MV.RData")
save(average_CM_overall_normedPhosphosites, file="average_CM_Phospho(STY)Sites_normed_without_full_MV.RData")
...
write.table(metrics_overall_proteinGroups, file="proteinGroups_avg_metrics_without_full_MV.txt", sep="\t", col.names=NA)
write.table(metrics_overall_Phosphosites, file="Phospho (STY)Sites_avg_metrics_without_full_MV.txt", sep="\t", col.names=NA)
write.table(metrics_overall_normedPhosphosites, file="Phospho (STY)Sites_normed_avg_metrics_without_full_MV.txt", sep="\t", col.names=NA)
